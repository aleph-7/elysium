...
import Acceptappointments from "./screens/acceptAppointments/acceptAppointments"
import Post from "./screens/postBlog/postBlog";
// import Stats from "./screens/stastistics/Stats";
          ...
          {cards.map((color, index) => {
            return (
              ...
              >
                ...
                {color == "1" ? <Availability></Availability> : null}
                {color == "2" ? <Acceptappointments/> : null}
                {color == "3" ? <Post></Post> : null}
                {/* {color == "3" ? <Stats></Stats> : null}
                {color == "4" ? <Post></Post> : null} */}
                {/* //CHANGE THE PAGES HERE */}
              </motion.li>
            );
          })}
