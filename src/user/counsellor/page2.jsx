...
function page2() {
    ...
    async function fetchData() {
      try {
        const response = await fetch(
          SERVER_ROOT_PATH + "/institute_counsellors"
        );
  ...
  const fillDaysDates = async (counsellorUsername) => {
    try {
      const response = await fetch(SERVER_ROOT_PATH + "/get_available_days", {
        method: "POST",
        headers: {
  ...
  const fillTimeSlots = async (counsellorUsername, selectedDate) => {
    try {
      const response = await fetch(
        SERVER_ROOT_PATH + "/get_available_time_slots",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const bookAppointment = async () => {
    ...
    try {
      const response = await fetch(
        SERVER_ROOT_PATH + "/book_counsellor_appointment",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
