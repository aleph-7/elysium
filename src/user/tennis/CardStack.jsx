...
import booknow from "../assets/tennis/booknow.png";
import tutorials from "../assets/tennis/tutorials.png";
import workshops from "../assets/tennis/workshops.jpg";
...
/* THIS CODE CONTAINS THE SWAPPABLE CARDS AND THE nav-tennisIGATION BAR, ALONG WITH ALL COMPONENTS CONNECTED */
          ...
          {cards.map((color, index) => {
            return (
              ...
              >
                ...
                {color == "3" ? <Workshop sport="tennis" /> : null}
                {color == "4" ? <Tutorial sport="tennis" /> : null}
