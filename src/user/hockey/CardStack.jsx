...
import booknow from "../assets/hockey/booknow.jpg";
import tutorials from "../assets/hockey/tutorials.png";
import workshops from "../assets/hockey/workshops.jpg";
import logo from "../assets/hockey/logo.jpg";
...
/* THIS CODE CONTAINS THE SWAPPABLE CARDS AND THE nav-hockeyIGATION BAR, ALONG WITH ALL COMPONENTS CONNECTED */
          ...
          {cards.map((color, index) => {
            return (
              ...
              >
                ...
                {color == "2" ? <Workshop sport="hockey" /> : null}
                {color == "3" ? <Tutorial sport="hockey" /> : null}
                {/* //CHANGE THE PAGES HERE */}
              </motion.li>
            );
          })}
