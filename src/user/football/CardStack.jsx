...
import booknow from "../assets/football/booknow.jpg";
import tutorials from "../assets/football/tutorials.png";
import workshops from "../assets/football/workshops.jpg";
...
/* THIS CODE CONTAINS THE SWAPPABLE CARDS AND THE nav-footballIGATION BAR, ALONG WITH ALL COMPONENTS CONNECTED */
          ...
          {cards.map((color, index) => {
            return (
              ...
              >
                ...
                {color == "2" ? <Workshop sport="football" /> : null}
                {color == "3" ? <Tutorial sport="football" /> : null}
                {/* //CHANGE THE PAGES HERE */}
              </motion.li>
            );
          })}
