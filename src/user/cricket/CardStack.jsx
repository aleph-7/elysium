...
import booknow from "../assets/cricket/booknow.jpg";
import tutorials from "../assets/cricket/tutorials.jpg";
import workshops from "../assets/cricket/workshops.jpg";
...
/* THIS CODE CONTAINS THE SWAPPABLE CARDS AND THE nav-cricketIGATION BAR, ALONG WITH ALL COMPONENTS CONNECTED */
          ...
          {cards.map((color, index) => {
            return (
              ...
              >
                ...
                {color == "2" ? <Workshop sport={"cricket"} /> : null}
                {color == "3" ? <Tutorial sport={"cricket"} /> : null}
                {/* //CHANGE THE PAGES HERE */}
              </motion.li>
            );
          })}
